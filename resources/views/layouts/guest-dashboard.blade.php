        ...
        <div>
            ...
            <nav class="p-4 pt-6 space-y-1">
                ...
                <a href="{{ route('guest.dashboard') }}" 
                   class="flex items-center gap-3.5 px-4 py-3 text-xs border-l-2 transition-all {{ Request::routeIs('guest.dashboard') ? 'font-bold bg-neutral-900/80 text-amber-400 border-amber-500' : 'font-medium hover:bg-neutral-900/40 hover:text-white border-transparent hover:border-neutral-700' }}">
                    <i class="fa-solid fa-square-poll-horizontal text-sm"></i> Dashboard
                </a>
                
                <a href="{{ route('guest.bookings.my') }}" 
                   class="flex items-center gap-3.5 px-4 py-3 text-xs border-l-2 transition-all {{ Request::routeIs('guest.bookings.my') ? 'font-bold bg-neutral-900/80 text-amber-400 border-amber-500' : 'font-medium hover:bg-neutral-900/40 hover:text-white border-transparent hover:border-neutral-700' }}">
                    <i class="fa-solid fa-calendar-days text-sm"></i> My Bookings
                </a>
                
                <a href="{{ route('guest.stay.my') }}" 
                   class="flex items-center gap-3.5 px-4 py-3 text-xs border-l-2 transition-all {{ Request::routeIs('guest.stay.my') ? 'font-bold bg-neutral-900/80 text-amber-400 border-amber-500' : 'font-medium hover:bg-neutral-900/40 hover:text-white border-transparent hover:border-neutral-700' }}">
                ...
                <a href="{{ route('guest.restaurant.orders') }}" 
                   class="flex items-center gap-3.5 px-4 py-3 text-xs border-l-2 transition-all {{ Request::routeIs('guest.restaurant.orders') ? 'font-bold bg-neutral-900/80 text-amber-400 border-amber-500' : 'font-medium hover:bg-neutral-900/40 hover:text-white border-transparent hover:border-neutral-700' }}">
                    <i class="fa-solid fa-utensils text-sm"></i> Restaurant
                </a>
                
                <a href="{{ route('guest.facilities.booking') }}" 
                   class="flex items-center gap-3.5 px-4 py-3 text-xs border-l-2 transition-all {{ Request::routeIs('guest.facilities.booking') ? 'font-bold bg-neutral-900/80 text-amber-400 border-amber-500' : 'font-medium hover:bg-neutral-900/40 hover:text-white border-transparent hover:border-neutral-700' }}">
                ...
                <a href="{{ route('profile.edit') }}" 
                   class="flex items-center gap-3.5 px-4 py-3 text-xs border-l-2 transition-all {{ Request::routeIs('profile.edit') ? 'font-bold bg-neutral-900/80 text-amber-400 border-amber-500' : 'font-medium hover:bg-neutral-900/40 hover:text-white border-transparent hover:border-neutral-700' }}">
        ...
        <div class="p-4 border-t border-neutral-900 space-y-4">
            <div class="p-4 bg-neutral-900/40 border border-neutral-900/60 flex items-center justify-between">
                <div>
                    ...
                    <span class="text-xs text-neutral-400 font-medium mt-0.5 inline-block">Resort Area</span>
                </div>
