...
Route::middleware(['auth'])->group(function () {
    ...
    // SUB-MENU INTERNAL DASHBOARD PORTAL
    ...
    // MANAGER & ADMIN ROLES WORKSPACE STUBS
...
Route::middleware(['auth'])->group(function () {
    Route::get('/my-stay', [HotelOperationalController::class, 'myStay'])->name('mystay');
    Route::get('/room-service', [HotelOperationalController::class, 'roomService'])->name('roomservice');
